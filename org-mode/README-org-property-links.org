...
- Insert long-form links (link and description), rendered as a clickable
  description, or short form links (link only), rendered as a section number.
...
Use C-c C-x l l (recommending binding) or =M-x org-property-links-insert-long=
to insert a link from existing link properties in the current buffer, with both
link target and description.

Use C-c C-x l s (recommending binding) or =M-x org-property-links-insert-short=
to insert a link from existing link properties in the current buffer, with both
link target and description.
